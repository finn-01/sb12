package vn.finn.spring.demospringjpaquery;
...
public class DemoSpringJpaQueryApplication {

    public static void main(String[] args) {

        ApplicationContext context = SpringApplication.run(DemoSpringJpaQueryApplication.class, args);
